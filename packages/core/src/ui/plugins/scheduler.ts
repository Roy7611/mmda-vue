 ...
 * App / 皮肤：builder.use(createSfSchedulerPlugin()) 或 createFcSchedulerPlugin()。
...
export interface UiSchedulerChangeEventArgs extends UiEventArgs {
...
export interface UiSchedulerProps<TNode = any> extends UiProps {
  ...
  onEventChange?: (
    event: UiSchedulerChangeEventArgs,
  ...
  eventContent?: (event: UiSchedulerEvent) => TNode
...
export function unimplementedSchedulerPlugin<
  TNode = any,
>(): UiSchedulerPlugin<TNode> {
