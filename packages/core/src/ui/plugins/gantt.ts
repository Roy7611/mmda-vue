...
export interface UiGanttChangeEventArgs extends UiEventArgs {
  action: string
  task?: UiGanttTask
  link?: UiGanttLink
  tasks?: UiGanttTask[]
...
export interface UiGanttProps extends UiProps {
  ...
  onRowReorder?: (task: UiGanttTask, event?: UiGanttChangeEventArgs) => void
}
...
export function unimplementedGanttPlugin<TNode = any>(): UiGanttPlugin<TNode> {
