...
import { type MetaUiService, type Module, type MetaUiField, type UiContext, defaultPager, EntityAction, ApiClient, MetaModel, isRefNone, EntityUrlParam } from '@mmda/core';
...
export class MaterialCatLogic extends UiLogic<MaterialCat> {
	...
	async create(param?: any, entityUrlParam?: EntityUrlParam): Promise<MaterialCat> {
 ...
 * @returns 
 */
export const MaterialCatLogicCtor = (metaUiService: MetaUiService, router: Router, module?: Module) => new MaterialCatLogic({
