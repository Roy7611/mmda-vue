...
export const LOGIC_LOADERS: Record<string, LogicLoader> = {
  ...
  MaterialCats: logic(() => import('./modules/materials/MaterialCatLogic'), 'MaterialCatLogic'),
  Materials: logic(() => import('./modules/materials/MaterialLogic'), 'MaterialLogic'),
  MaterialNSkus: logic(() => import('./modules/materials/MaterialNSkuLogic'), 'MaterialNSkuLogic'),
  MaterialPackages: logic(() => import('./modules/materials/MaterialPackageLogic'), 'MaterialPackageLogic'),
