 ...
 * App / 皮肤：builder.use(createSfKanbanPlugin())
 */
import {
...
import type { UiKanbanCard, UiKanbanColumn, UiKanbanProps } from '@mmda/vui'
import { kanbanDragEnabled, kanbanHookClass, UiPluginName, type UiPlugin } from '@mmda/vui'
...
export function createSfKanbanPlugin(): UiPlugin {
  return {
    ...
    buildUi(_context, props) {
      return h(SfKanbanView, props as any)
    },
  }
}
