 ...
 * App / 皮肤：builder.use(createSfAiAssistantPlugin())
 */
import {
...
import type { UiAiAssistantController, UiAiAssistantProps, UiAiPromptRequest, UiAiResponseMode } from '@mmda/vui'
import { aiAssistantHookClass, UiPluginName, type UiPlugin } from '@mmda/vui'
...
export function createSfAiAssistantPlugin(): UiPlugin {
  return {
    ...
    buildUi(_context, props) {
      return h(SfAiAssistantView, props as UiAiAssistantProps as any)
    },
  }
}
