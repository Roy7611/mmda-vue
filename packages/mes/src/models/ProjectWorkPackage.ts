...
import { type ProjectWorkPackageItem, defineProjectWorkPackageItem } from './ProjectWorkPackageItem';
 ...
 *
 */
export interface ProjectWorkPackage extends Entity {
 ...
 * 项目工作包实体定义函数
 */
export const defineProjectWorkPackage = (o: object) => {
	const e = defineEntity<ProjectWorkPackage>(o);

	//执行追踪
	e.items = defineEntityArray(defineProjectWorkPackageItem, e.items);
