 ...
 *
 */
export interface MaterialTransItem extends Entity {
 ...
 * 移料单明细实体定义函数
 */
export const defineMaterialTransItem = (o: object) => {
	const e = defineEntity<MaterialTransItem>(o);
	//定义id
	Object.defineProperty(e,'id',{
		get: function(){ return `${this.transID},${this.itemID}` }
	});
	/**
