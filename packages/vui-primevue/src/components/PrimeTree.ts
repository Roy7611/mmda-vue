...
import { mapTreeNodes, resolveMappedTreeDrop, selectedIdSet, type UiTreeFields, type UiTreeMappedNode, type UiTreeProps } from '@mmda/vui'
...
export const PrimeTree = defineComponent({
  name: 'PrimeTree',
  props: {
