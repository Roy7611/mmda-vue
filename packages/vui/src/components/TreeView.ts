    ...
    return () => {
      ...
      return h(
        ...
        [
          ...
          showFooter
            ? h(TreeViewFooter, { spec, node: picked.value })
            : null,
        ],
      );
    };
    ...
    return () => {
      ...
      return h(
        ...
        props.factory.tree({
          ...
          onNodeSelect: props.onNodeSelect as any,
          onExpand: props.onExpand as any,
          onNodeRename: props.onNodeRename as any,
          onNodeMove: props.onNodeMove as any,
        }),
      );
    };
  },
