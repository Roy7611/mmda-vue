...
import type { UiPivotTableProps } from '@mmda/vui'
import { pivotAggregateOf, pivotDataOf, pivotHookClass, UiPluginName, type UiPlugin } from '@mmda/vui'
...
export function createAgPivotPlugin(): UiPlugin {
  return {
    name: UiPluginName.pivotTable,
    buildUi(_context, props) {
      return createAgPivotTable(props as UiPivotTableProps)
    },
  }
}
